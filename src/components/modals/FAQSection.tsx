...
const FAQ_DATA: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        question: "How do I deploy VeloAnalytics to Vercel?",
        beginnerAnswer: "You can host your own private version of VeloAnalytics on Vercel for free. It involves connecting your GitHub account and pasting your sensitive API keys into Vercel's secure settings.",
        technicalAnswer: "Vercel is the recommended hosting provider for this Vite/React application. You can find a detailed Step-by-Step guide in the 'docs/DEPLOY_VERCEL.md' file in the project root. It covers environment variable configuration and CI/CD setup.",
        keywords: ["vercel", "deploy", "host", "online", "private", "website"]
      },
      {
        question: "Can I build VeloAnalytics as a desktop app with Tauri?",
        beginnerAnswer: "Yes! If you want a standalone app on your Windows or Mac computer that doesn't need a browser, you can use a tool called Tauri to build it. This is great for privacy and speed.",
        technicalAnswer: "Tauri allows you to bundle this web application into a native binary. A detailed Step-by-Step guide for installing the Rust toolchain and running the build command is available in 'docs/LOCAL_BUILD.md'.",
        keywords: ["tauri", "desktop", "app", "exe", "dmg", "local", "rust", "windows", "mac"]
      },
      {
